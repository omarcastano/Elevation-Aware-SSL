...
from MasterThesis.models.segmentation.simclr import DeepLab
...
def train_model(
    ...
    # Define paths to save and load model
...
def run_train(
    ...
    # loss  functiction
    loss = NTXentLoss(temperature=wandb_kwargs["config"]["temperature"])

    # Optimizer
    optimizer = optim.AdamW(
        model.parameters(), lr=wandb_kwargs["config"]["learning_rate"], weight_decay=wandb_kwargs["config"]["weight_decay"]
    )
