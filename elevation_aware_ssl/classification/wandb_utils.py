    ...
    df = pd.DataFrame(
        {
            ...
            "train_size": np.array(metric_train_size),
        }
    )
...
def barplot_metrics_from_wandb(
    project: str = "elevation_aware_ssl",
...
def get_table(
    ...
    """
    Helper function to get tables which are stored as wandb artifacts
...
def plot_pr_curve(table: pd.DataFrame, color: str = None, line_dash: str = None):
    ...
    ----------
        ...
        line_dash: values from this column are used to assign line style
